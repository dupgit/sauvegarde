...
# Creating files in the monitored directory (commented out because fanotify is not implemented in travis-ci)
...
# Trying to restore one file (the other one is not created)
